<template>
    ...
    <div class="min-h-screen text-stone-800 bg-gradient-to-br from-stone-200 to-teal-50">
        <nav class="bg-white shadow text-lg px-4 z-50">
            <div class="container mx-auto flex flex-wrap items-center justify-between h-20">
                ...
                <ul class="hidden lg:flex space-x-16 font-heading">
                     ...
                     <li class="hover:text-teal-700 transition-color"><NuxtLink :to="'/baerekraft'" @click="open = false">Bærekraft</NuxtLink></li>
                     <li class="hover:text-teal-700 transition-color"><NuxtLink :to="'/posts'" @click="open = false">Artikler</NuxtLink></li>
                     <li class="hover:text-teal-700 transition-color"><NuxtLink :to="'/kontakt'" @click="open = false">Kontakt</NuxtLink></li>
                </ul>
                <div>
        ...
        <footer class="p-4 bg-white shadow  dark:bg-stone-800 mt-16">
            ...
            <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://nggroup.no" class="hover:underline">Norsk Gjenvinning Norge AS</a>. Alle rettigheter.</span>
            <ul class="flex space-x-4 flex-wrap items-center mt-3 text-sm text-gray-500 dark:text-gray-400 sm:mt-0">
               <li><NuxtLink :to="'/om-oss'" @click="open = false">Om oss</NuxtLink></li>
                     <li><NuxtLink :to="'/baerekraft'" @click="open = false">Bærekraft</NuxtLink></li>
                     <li><NuxtLink :to="'/posts'" @click="open = false">Artikler</NuxtLink></li>
                     <li><NuxtLink :to="'/kontakt'" @click="open = false">Kontakt</NuxtLink></li>
            </ul>
            </div>
        </footer>
    </div>
